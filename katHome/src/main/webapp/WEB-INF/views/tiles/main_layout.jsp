...
<script type="text/javascript" src="${jsUrl}common/jquery.flexslider.js"></script>
<script type="text/javascript" src="${jsUrl}main.js"></script>
<script type="text/javascript" src="${jsUrl}common/slide.js"></script>
...
<link rel="stylesheet" type="text/css" href="${cssUrl}flexslider.css" />
<script>
