...
<script type="text/javascript" src="${jsUrl}admin/statistice_device.js"></script>
...
<section class="container">
	<div class="topic_form">
		...
		<ul class="location">
			...
			<li><a href="/admin/statisticsDevice" title="Device Category별 접속통계" class="present">Device Category별 접속통계</a></li>
		</ul>
	</div>
	<div class="content">
		...
		<table class="tb1" summary="Mobile 기기별 접속통계">
			...
			<thead>
				<tr style="cursor:pointer">
					<th scope="col" onclick="tableSort(divice_contents,0);" title="Device Category">Device Category<a href="javascript:;" id="sort_0" class="sort"></a></th>
					<th scope="col" onclick="tableSort(divice_contents,1);" title="Users">Users<a href="javascript:;" id="sort_1" class="sort"></a></th>
				</tr>
			</thead>
			<tbody id="divice_contents">
			</tbody>
		</table>
	</div>
</section>
...
<script>
	...
	function queryTotalReporting() {
		...
		gapi.client.analytics.data.ga.get({
	    	...
	    	$(".sort").removeClass("btn_down");
			$(".sort").removeClass("btn_up");
	    	$("#divice_contents").html("");
	    	$("#divice_contents").html("<tr><td colspan='2'>No Data</td></tr>");
	    	diviceCreateTable(json_parse);
	  	}).then(null, function(err) {
	      // Log any errors.
	      console.log(err);
	  	});
