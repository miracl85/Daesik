...
<script type="text/javascript" src="${jsUrl}admin/json2.js"></script>
...
<script type="text/javascript" src="${jsUrl}admin/statistice_os.js"></script>
...
<section class="container">
	<div class="topic_form">
		...
		<ul class="location">
			...
			<li><a href="/admin/statisticsOs" title="OS/Browser 별 접속통계" class="present">OS/Browser 별 접속통계</a></li>
		</ul>
	</div>
	<div class="content">
		...
		<div id="create_table">
			<table class="tb1" summary="OS/Browser 별 접속통계" id="os_table">
				<caption>OS/Browser 별 접속통계 테이블</caption>
				<colgroup>
					<col />
					<col />
					<col />
				...
				<thead>
					<tr style="cursor:pointer">
						<th scope="col" onclick="tableSort(os_contents,0);" title="Browser">Browser<a href="javascript:;" id="sort_0" class="sort"></a></th>
						<th scope="col" onclick="tableSort(os_contents,1);" title="Browser Version">Browser Version<a href="javascript:;" id="sort_1" class="sort"></a></th>
						<th scope="col" onclick="tableSort(os_contents,2);" title="Operating System">Operating System<a href="javascript:;" id="sort_2" class="sort"></a></th>
						<th scope="col" onclick="tableSort(os_contents,3);;" title="Operating System Version">Operating System Version<a href="javascript:;" id="sort_3" class="sort"></a></th>
						<th scope="col" onclick="tableSort(os_contents,4);;" title="Users">Users<a href="javascript:;" id="sort_4" class="sort"></a></th>
					</tr>
				</thead>
				<tbody id="os_contents">
				</tbody>
			</table>
		</div>
...
<script>
	...
	function queryTotalReporting() {
		...
		gapi.client.analytics.data.ga.get({
			...
			$(".sort").removeClass("btn_up");
	    	$("#os_contents").html("");
	    	$("#os_contents").html("<tr><td colspan='5'>No Data</td></tr>");
	    	OSCreateTable(json_parse);
	  	}).then(null, function(err) {
	      // Log any errors.
	      console.log(err);
	  	});
